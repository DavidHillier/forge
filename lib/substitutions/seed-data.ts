...
export const canonicalExercises: CanonicalDef[] = [
  ...
  {
    name: "Dumbbell swing",
    movementPattern: "Ballistic hip hinge",
    primaryMuscles: ["glutes", "hamstrings", "spinal erectors", "grip"],
    equipment: ["Dumbbells"],
    difficulty: "moderate",
    impactLevel: "moderate",
    jointStressLevel: "low",
    isCanonical: true,
    formCues: ["Hinge at the hips, not the knees.", "Drive hips forward powerfully.", "Keep arms relaxed.", "Let the hips power the weight."],
    substitutes: [
      { name: "Kettlebell two-handed swing", movementPattern: "Ballistic hip hinge", primaryMuscles: ["glutes","hamstrings","spinal erectors"], equipment: ["Kettlebells"], difficulty: "moderate", impactLevel: "moderate", jointStressLevel: "low", formCues: ["Hinge from hips.", "Snap hips to drive bell.", "Keep back flat."], substitutionReasons: ["closest_match","equipment_unavailable","conditioning"], matchQuality: "excellent", intensityChange: "same", difficultyChange: "same", recommendationRank: 1 },
      { name: "Dumbbell Romanian deadlift", movementPattern: "Hip hinge", primaryMuscles: ["glutes","hamstrings","spinal erectors"], equipment: ["Dumbbells"], difficulty: "moderate", impactLevel: "low", jointStressLevel: "low", formCues: ["Push hips back.", "Keep bar close.", "Stop when back starts to round."], substitutionReasons: ["joint_friendly","easier","heavier_strength"], matchQuality: "good", intensityChange: "lower", difficultyChange: "easier", recommendationRank: 2, scalingNote: "Removes the ballistic element. Increase reps." },
      { name: "Kettlebell single-arm swing", movementPattern: "Ballistic hip hinge", primaryMuscles: ["glutes","hamstrings","spinal erectors","trunk"], equipment: ["Kettlebells"], difficulty: "moderate", impactLevel: "moderate", jointStressLevel: "low", formCues: ["Same hip hinge pattern.", "Switch hands at top.", "Keep trunk stable."], substitutionReasons: ["conditioning","harder","closest_match"], matchQuality: "excellent", intensityChange: "same", difficultyChange: "harder", recommendationRank: 3 },
      { name: "Barbell Romanian deadlift", movementPattern: "Hip hinge", primaryMuscles: ["glutes","hamstrings","spinal erectors"], equipment: ["Barbell"], difficulty: "moderate", impactLevel: "low", jointStressLevel: "low", formCues: ["Hinge from hips.", "Bar drags down shins.", "Flat back throughout."], substitutionReasons: ["heavier_strength"], matchQuality: "good", intensityChange: "higher", difficultyChange: "same", recommendationRank: 4 },
      { name: "Barbell conventional deadlift", movementPattern: "Hip hinge", primaryMuscles: ["glutes","hamstrings","spinal erectors","quads"], equipment: ["Barbell"], difficulty: "moderate", impactLevel: "low", jointStressLevel: "moderate", formCues: ["Brace hard.", "Push floor away.", "Hips and shoulders rise together."], substitutionReasons: ["heavier_strength"], matchQuality: "good", intensityChange: "higher", difficultyChange: "same", recommendationRank: 5 },
      { name: "Single-leg Romanian deadlift", movementPattern: "Unilateral hip hinge", primaryMuscles: ["glutes","hamstrings"], equipment: ["Dumbbells","Bodyweight"], difficulty: "moderate", impactLevel: "low", jointStressLevel: "low", formCues: ["Stand on one leg.", "Hinge until torso is parallel.", "Squeeze glute to return."], substitutionReasons: ["joint_friendly","harder"], matchQuality: "fair", intensityChange: "same", difficultyChange: "harder", recommendationRank: 6 },
      { name: "Kettlebell snatch", movementPattern: "Ballistic hip hinge", primaryMuscles: ["glutes","hamstrings","shoulders","grip"], equipment: ["Kettlebells"], difficulty: "advanced", impactLevel: "high", jointStressLevel: "moderate", formCues: ["Drive from hips.", "Punch through at top.", "Land softly."], substitutionReasons: ["conditioning","harder"], matchQuality: "good", intensityChange: "higher", difficultyChange: "harder", recommendationRank: 7, isAdvanced: true, cautionNote: "Technical movement. Learn with light weight first." },
      { name: "Kettlebell clean", movementPattern: "Ballistic hip hinge", primaryMuscles: ["glutes","hamstrings","shoulders"], equipment: ["Kettlebells"], difficulty: "moderate", impactLevel: "moderate", jointStressLevel: "low", formCues: ["Hinge, then pull close.", "Catch in rack position.", "Absorb with knees."], substitutionReasons: ["conditioning","equipment_unavailable"], matchQuality: "good", intensityChange: "same", difficultyChange: "same", recommendationRank: 8 },
      { name: "Barbell good morning", movementPattern: "Hip hinge", primaryMuscles: ["spinal erectors","glutes","hamstrings"], equipment: ["Barbell"], difficulty: "advanced", impactLevel: "low", jointStressLevel: "high", formCues: ["Bar on upper back.", "Hinge until torso near parallel.", "Keep back flat."], substitutionReasons: ["heavier_strength"], matchQuality: "fair", intensityChange: "higher", difficultyChange: "harder", recommendationRank: 9, isAdvanced: true, cautionNote: "High spinal load. Use only if technically proficient." },
      { name: "Kettlebell high pull", movementPattern: "Ballistic hip hinge + pull", primaryMuscles: ["glutes","hamstrings","shoulders","traps"], equipment: ["Kettlebells"], difficulty: "moderate", impactLevel: "moderate", jointStressLevel: "moderate", formCues: ["Hinge and drive.", "Pull elbow high.", "Control the descent."], substitutionReasons: ["conditioning","closest_match"], matchQuality: "good", intensityChange: "same", difficultyChange: "same", recommendationRank: 10 },
    ],
  },
  ...
  // ─── 10. Dumbbell bent-over row ───────────────────────────────────────────
  {
    ...
    substitutes: [
      ...
      { name: "Pull-up", movementPattern: "Vertical pull", primaryMuscles: ["lats","biceps","mid traps"], equipment: ["Pull-up bar"], difficulty: "moderate", impactLevel: "low", jointStressLevel: "low", formCues: ["Full hang.", "Pull until chin over bar.", "Lower slowly."], substitutionReasons: ["harder","conditioning","bodyweight"], matchQuality: "good", intensityChange: "higher", difficultyChange: "harder", recommendationRank: 4 },
